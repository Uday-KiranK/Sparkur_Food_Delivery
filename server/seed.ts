...
async function main() {
  ...
  const foodCategoriesData = [
    ...
    },
    {
      name: "Chinese",
      image_url:
        "https://images.unsplash.com/photo-1563245372-f21724e3856d?q=80&w=300&auto=format&fit=crop",
    },
    {
      name: "Indian",
      image_url:
    ...
    },
    {
      name: "Italian",
      image_url:
        "https://images.unsplash.com/photo-1601276861758-2d9c5ca69de2?q=80&w=300&auto=format&fit=crop",
    },
    {
      name: "Dessert",
      image_url:
  ...
  const createdFoodCategories = await db
    .insert(food_categories)
    .values(foodCategoriesData)
    .returning();
  console.log(`✅ Created ${createdFoodCategories.length} food categories`);

  // Create restaurants
  const restaurantAdmin = createdUsers.find(
    (user) => user.role === UserRole.RESTAURANT_ADMIN,
  );
  if (!restaurantAdmin) {
  ...
  const restaurantsData = [
    {
      name: "Pizza Palace",
      description:
        "Authentic Italian pizzas with a variety of toppings. Our dough is freshly made daily and baked in a wood-fired oven.",
    ...
    },
    {
      ...
      description:
        "Juicy burgers with premium ingredients. We grind our beef daily and all our sauces are homemade.",
      admin_id: restaurantAdmin.id,
    ...
    },
    {
      name: "Sushi Symphony",
      description:
        "Fresh and authentic Japanese sushi prepared by expert chefs. We use only the freshest ingredients.",
      admin_id: restaurantAdmin.id,
    ...
    },
    {
      name: "Spice Garden",
      description:
        "Authentic Indian cuisine with a modern twist. Our spices are imported directly from India.",
      admin_id: restaurantAdmin.id,
    ...
    },
    {
      name: "Green Basket",
      description:
        "Healthy and nutritious meals for the health-conscious. All our produce is locally sourced and organic.",
      admin_id: restaurantAdmin.id,
    ...
    },
    {
      name: "Dragon Wok",
      description:
        "Authentic Chinese cuisine with recipes passed down through generations. We use traditional cooking techniques.",
      admin_id: restaurantAdmin.id,
    ...
    },
    {
      name: "Sweet Tooth",
      description:
        "Delicious desserts and pastries that will satisfy your sweet cravings. All our desserts are made fresh daily.",
      admin_id: restaurantAdmin.id,
    ...
    },
    {
      name: "Pasta Paradise",
      description:
        "Authentic Italian pasta made with imported ingredients. Our pasta is handmade daily.",
      admin_id: restaurantAdmin.id,
      address: "505 Pasta Lane, Italytown",
      image_url:
        "https://images.unsplash.com/photo-1601276861758-2d9c5ca69de2?q=80&w=500&auto=format&fit=crop",
  ...
  const createdRestaurants = await db
    .insert(restaurants)
    .values(restaurantsData)
    .returning();
  ...
  const findRestaurant = (name: string) =>
    createdRestaurants.find((r) => r.name === name);
  ...
  const findCategory = (restaurantId: number, name: string) =>
    createdCategories.find(
      (c) => c.restaurant_id === restaurantId && c.name === name,
    );
      ...
      menuItemsData.push(
        {
          ...
          image_url:
            "https://images.unsplash.com/photo-1619683548505-f31c8e963a85?q=80&w=300&auto=format&fit=crop",
        },
        {
          ...
          image_url:
            "https://images.unsplash.com/photo-1604068549290-dea0e4a305ca?q=80&w=300&auto=format&fit=crop",
        },
        {
        ...
        },
        {
          ...
          description:
            "Specialty pizza with truffle oil, mushrooms, and arugula",
          price: 550,
          is_veg: true,
          is_available: true,
          restaurant_id: pizzaPalace.id,
          ...
          image_url:
            "https://images.unsplash.com/photo-1589840700256-41c5d199f5d4?q=80&w=300&auto=format&fit=crop",
        },
        {
          name: "Tiramisu",
          description:
          ...
          image_url:
            "https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?q=80&w=300&auto=format&fit=crop",
        },
        {
          name: "Italian Soda",
      ...
      menuItemsData.push(
        {
          ...
          category_id: startersCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1606755456206-b25206cde27e?q=80&w=300&auto=format&fit=crop",
        },
        {
        ...
        },
        {
          ...
          category_id: mainCourseCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1585238342024-78d387f4a707?q=80&w=300&auto=format&fit=crop",
        },
        {
          ...
          category_id: specialtyCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1553979459-d2229ba7433b?q=80&w=300&auto=format&fit=crop",
        },
        {
          ...
          category_id: beveragesCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1619158401201-8fa932695178?q=80&w=300&auto=format&fit=crop",
        },
      );
    }
  }
      ...
      menuItemsData.push(
        {
          ...
          category_id: startersCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1547592166-23ac45744acd?q=80&w=300&auto=format&fit=crop",
        },
        {
        ...
        },
        {
          name: "Salmon Nigiri",
          description:
            "Fresh salmon slices served on top of pressed vinegared rice",
          price: 300,
          is_veg: false,
          is_available: true,
          restaurant_id: sushiSymphony.id,
          category_id: mainCourseCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1648147526775-dce0f1e46047?q=80&w=300&auto=format&fit=crop",
        },
        {
          name: "Deluxe Sushi Platter",
          description:
            "Assortment of premium sushi including tuna, salmon, and eel",
          price: 850,
          is_veg: false,
          is_available: true,
          restaurant_id: sushiSymphony.id,
          category_id: specialtyCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1617196034183-421b4917c92d?q=80&w=300&auto=format&fit=crop",
        },
        {
          name: "Green Tea Ice Cream",
          description:
            "Traditional Japanese dessert with a unique green tea flavor",
          price: 180,
          is_veg: true,
          is_available: true,
          restaurant_id: sushiSymphony.id,
          category_id: dessertsCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1505394033641-40c6ad1178d7?q=80&w=300&auto=format&fit=crop",
        },
        {
          name: "Sake",
          ...
          category_id: beveragesCategory.id,
          image_url:
            "https://images.unsplash.com/photo-1536935338788-846bb9981813?q=80&w=300&auto=format&fit=crop",
        },
      );
    }
  }
  ...
  for (const restaurant of createdRestaurants) {
    if (
      ["Pizza Palace", "Burger Boulevard", "Sushi Symphony"].includes(
        restaurant.name,
      )
    ) {
    ...
    if (startersCategory && mainCourseCategory) {
      ...
      let starterImg =
        "https://images.unsplash.com/photo-1541528906260-fca9c949e480?q=80&w=300&auto=format&fit=crop";

      let mainName = "Main Dish";
      let mainDesc = "Flavorful main course prepared by our expert chefs";
      let mainPrice = 350;
      let mainImg =
        "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?q=80&w=300&auto=format&fit=crop";
      ...
      if (cuisineType === "Indian") {
        ...
        starterImg =
          "https://images.unsplash.com/photo-1595436252086-7496fb8118bb?q=80&w=300&auto=format&fit=crop";
        ...
        starterDesc =
          "Mix of fresh vegetables with olive oil and balsamic dressing";
        starterImg =
          "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=300&auto=format&fit=crop";
        ...
        mainImg =
          "https://images.unsplash.com/photo-1539136788836-5699e78bfc75?q=80&w=300&auto=format&fit=crop";
      } else if (cuisineType === "Dessert") {
        starterName = "Fresh Fruit Platter";
        starterDesc = "Assortment of seasonal fresh fruits";
        starterImg =
          "https://images.unsplash.com/photo-1611080626919-7cf5a9dbab2c?q=80&w=300&auto=format&fit=crop";

        mainName = "Chocolate Cake";
        mainDesc =
          "Rich chocolate cake with a molten center and vanilla ice cream";
        mainImg =
          "https://images.unsplash.com/photo-1605807646983-377bc5a76493?q=80&w=300&auto=format&fit=crop";
      }
