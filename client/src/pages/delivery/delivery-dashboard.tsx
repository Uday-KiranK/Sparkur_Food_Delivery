            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <p>
                    <span className="text-[#686b78]">Total Amount:</span> ₹
                ...
                <div>
                  ...
                  <p>
                    <span className="text-[#686b78]">Restaurant ID:</span>{" "}
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-lg font-bold mb-4 flex items-center">
                  <span className="w-3 h-3 bg-[#FC8019] rounded-full mr-2"></span>{" "}
                  My Deliveries
                </h2>
                ...
                <p className="text-2xl font-bold">
                  ...
                  {completedOrders
                    .filter((order) => {
                      ...
                      const deliveryDate = order.delivery_time
                    ...
                    .reduce(
                      (sum, order) =>
                        sum + Math.round(order.total_amount * 0.1),
                      0,
                    )}
                </p>
                <p className="text-sm text-[#686b78]">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-2xl font-bold">
                  ...
                  {completedOrders.reduce(
                    (sum, order) => sum + Math.round(order.total_amount * 0.1),
                    0,
                  )}
                </p>
                <p className="text-sm text-[#686b78]">
